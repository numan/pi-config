...
| `/planning` | Break work into small, verifiable tasks | `write-todos` |
...
| `/review` | Five-axis code review | `code-reviewer` |
| `/code-simplify` | Reduce complexity without changing behavior | `code-simplifier` |

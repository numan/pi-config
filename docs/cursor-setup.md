...
cp /path/to/agent-skills/skills/code-reviewer/SKILL.md .cursor/rules/code-reviewer.md
...
echo "\n---\n" >> .cursorrules
cat /path/to/agent-skills/skills/code-reviewer/SKILL.md >> .cursorrules
```
...
2. `reviewer.md` — Five-axis review
...
3. **Use agents for review** - Copy `agents/reviewer.md` content and tell Cursor to "review this diff using this code review framework."

...
export function validateAgentMetadata({ metadata, fileName, skillNames }) {
  ...
  if (!["openai-codex/gpt-6-astra", "openai-codex/gpt-6-sol"].includes(metadata.model)) {
    issues.push("model must be openai-codex/gpt-6-astra or openai-codex/gpt-6-sol");
  }

---
name: interview-me
description: Interview the user one question at a time when the underlying goal is materially unclear or they explicitly request an interview or grilling.
---
...
- **`write-todos`**: two hops downstream of this skill (after the spec).

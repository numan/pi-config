---
name: learn-codebase
description: Onboard to an unfamiliar codebase by mapping project instructions and conventions and performing a bounded security and configuration smell sweep.
---

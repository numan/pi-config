---
name: unslop
description: Edit prose to remove common AI-writing tells while preserving meaning and adding a specific human voice. Use when drafting, rewriting, polishing, or reviewing prose, documentation, reports, and user-facing explanations.
...
7. **AI vocabulary.** Prefer plain words over "additionally," "crucial," "delve," "enduring," "enhance," "fostering," "garner," "interplay," "intricate," "landscape" used abstractly, "pivotal," "showcase," "tapestry," "testament," "underscore," and "vibrant."
8. **Fancy ways to say "is."** Replace "serves as," "stands as," "boasts," and often "features" with "is" or "has."
9. **"Not just X, but Y."** State the point directly.
10. **Forced groups of three.** Use the natural number of examples or points.
11. **Synonym cycling.** Pick one accurate term and repeat it when needed.
12. **False ranges.** Do not write "from X to Y" unless X and Y form a meaningful scale.

### Style

13. **Em dash overuse.** Prefer a period or comma. Do not swap every dash for parentheses.
14. **Colon overuse.** Use colons for genuine lists or examples, not as a default sentence connector.
15. **Boldface overuse.** Bold only where it helps scanning.
16. **Inline-header lists.** Avoid bold labels that merely repeat the sentence. A useful lead-in should add structure, not duplicate content.
17. **Title Case Headings.** Use sentence case.
18. **Decorative emojis.** Remove them from headings and bullets unless the requested voice calls for them.
19. **Curly quotes.** Use the target project's typography rules. Default to straight quotes in code-oriented Markdown.

### Communication artifacts

20. **Chatbot phrases.** Remove "I hope this helps," "Let me know if," "Of course," "Certainly," and canned discoveries such as "Found the smoking gun."
21. **Cutoff disclaimers.** Find the missing source or remove the unsupported claim.
22. **Sycophancy.** Skip praise such as "Great question" and answer directly.

### Filler

23. **Filler phrases.** Replace "in order to" with "to" and "due to the fact that" with "because." Delete "it is important to note that."
24. **Excessive hedging.** Use one accurate qualifier.
25. **Generic conclusions.** Replace broad optimism or concern with a specific plan, fact, or consequence.
...
27. **Describe the mechanism.** Replace feelings and generic claims with a concrete instruction, fact, number, or example. Cut a sentence if it could appear unchanged in another project's documentation.
28. **Split dense sentences.** Keep one main idea per sentence when possible.
29. **Prefer active voice.** Name the actor when it matters. Keep passive voice when the actor is unknown or irrelevant.
30. **Cut weak adverbs.** Use a stronger verb or measured value.
31. **Prefer the plain word.** Use "use," "help," "many," and "if" instead of "utilize," "facilitate," "numerous," and "in the event that."
